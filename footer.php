            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p class="footer__copyright__text">Copyright &copy;
                        ...
                        All rights reserved | Made </i> by <a href="https://crispinmanda.github.io/Portfolio/" target="_blank">Crispin Manda</a>
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
...
<script src="<?php echo esc_url(get_template_directory_uri());?>/js/mixitup.min.js"></script>
<script src="<?php echo esc_url(get_template_directory_uri());?>/js/masonry.pkgd.min.js"></script>
<script src="<?php echo esc_url(get_template_directory_uri());?>/js/jquery.slicknav.js"></script>
